      ...
      <main id="contact-page">
        <div className="container">
          <div className="w-full mb-8 text-center md:text-left">
            <h1 className="text-4xl font-bold text-gray-800">Pronto para revolucionar o seu negócio?</h1>
            <p className="text-gray-600 mt-2">Entre em contato e seja um parceiro Agroshop!</p>
          </div>
          <div className="contact-info">
            <div className="info-item">
              <svg className="icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Para empresas, compras em escala ou parcerias.</p>
              </div>
            </div>
            <div className="info-item">
              <svg className="icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Atendimento: Segunda a sexta, as 9h às 18h</p>
              </div>
            </div>
            <div className="info-item">
              <svg className="icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">(Visitas apenas com agendamento)</p>
              </div>
            </div>
          </div>
          <div className="contact-form">
            <h2 className="text-2xl font-semibold text-gray-800 mb-6">Formulário de Contato Direto</h2>
            <form id="contactForm" className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" id="phone" name="phone" placeholder="Celular (com DDD)"
                    className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
                </div>
              </div>
              <div>
                <label htmlFor="message" className="sr-only">Mensagem</label>
                <textarea id="message" name="message" placeholder="Mensagem" rows={6}
                  className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"></textarea>
            ...
            <div id="successModal" className="fixed inset-0 bg-gray-600 bg-opacity-50 hidden flex items-center justify-center p-4">
              <div className="bg-white rounded-lg p-8 shadow-xl max-w-sm w-full text-center">
                <p className="text-xl font-semibold text-gray-800 mb-4">Mensagem Enviada com Sucesso!</p>
                <button id="closeModal" className="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition duration-300">OK</button>
              </div>
            </div>
          </div>
        </div>
